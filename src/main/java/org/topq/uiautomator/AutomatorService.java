...
public interface AutomatorService {
	 ...
	 */
	@JsonRpcErrors({ @JsonRpcError(exception = NotImplementedException.class, code = ERROR_CODE_BASE - 3) })
	String takeScreenshot(String filename, float scale, int quality)
			throws NotImplementedException;
	...
	void freezeRotation(boolean freeze) throws RemoteException; // freeze or
																// unfreeze
																// rotation, see
																// also
																// unfreezeRotation()
	 ...
	 */
	@JsonRpcErrors({
			@JsonRpcError(exception = RemoteException.class, code = ERROR_CODE_BASE - 1),
			@JsonRpcError(exception = NotImplementedException.class, code = ERROR_CODE_BASE - 3) })
	void setOrientation(String dir) throws RemoteException,
	 ...
	 */
	boolean hasWatcherTriggered(String watcherName); // We should implement some
														// watchers to treat
	 ...
	 */
	void registerClickUiObjectWatcher(String name, Selector[] conditions,
			Selector target);
	 ...
	 */
	void registerPressKeyskWatcher(String name, Selector[] conditions,
			String[] keys);
	...
	@JsonRpcErrors({
			@JsonRpcError(exception = UiObjectNotFoundException.class, code = ERROR_CODE_BASE - 2),
			@JsonRpcError(exception = NotImplementedException.class, code = ERROR_CODE_BASE - 3) })
	boolean gesture(Selector obj, Point startPoint1, Point startPoint2,
	 ...
	 */
	@JsonRpcErrors({ @JsonRpcError(exception = UiObjectNotFoundException.class, code = ERROR_CODE_BASE - 2) })
	boolean scrollToBeginning(Selector obj, boolean isVertical, int maxSwipes,
	 ...
	 */
	@JsonRpcErrors({ @JsonRpcError(exception = UiObjectNotFoundException.class, code = ERROR_CODE_BASE - 2) })
	boolean scrollToEnd(Selector obj, boolean isVertical, int maxSwipes,
			int steps) throws UiObjectNotFoundException;
	...
	/***************************************************************************
	 * Some time we have to use chained selection, e.g. new
	 * UiCollection(...).getChildByText(...).getChild().... So we should have a
	 * mechanism to save the previous UiObject.
	 ***************************************************************************/
	 ...
	 */
	@JsonRpcErrors({ @JsonRpcError(exception = UiObjectNotFoundException.class, code = ERROR_CODE_BASE - 2) })
	String getChild(String obj, Selector selector)
			throws UiObjectNotFoundException;
	...
	@JsonRpcErrors({
			@JsonRpcError(exception = UiObjectNotFoundException.class, code = ERROR_CODE_BASE - 2),
			@JsonRpcError(exception = NotImplementedException.class, code = ERROR_CODE_BASE - 3) })
	boolean gesture(String obj, Point startPoint1, Point startPoint2,
			Point endPoint1, Point endPoint2, int steps)
			throws UiObjectNotFoundException, NotImplementedException;
